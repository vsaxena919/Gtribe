...
class Youzer_Wall_Form {
	...
	function validate( $post, $is_ajax = false ) {
		...
		if ( apply_filters( 'yz_validate_wall_form_post_type', true ) ) {
			...
			$allowed_post_types = apply_filters( 'yz_allowed_form_post_types', array(
				'activity_status', 'activity_photo', 'activity_video' , 'activity_audio',
				'activity_link', 'activity_slideshow','activity_file', 'activity_quote', 'activity_giphy' )
			);
