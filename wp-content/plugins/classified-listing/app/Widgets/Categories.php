...
class Categories extends \WP_Widget
{
    ...
    public function __construct() {
        ...
        parent::__construct(
            $this->widget_slug,
            __('Classified Listing Categories', 'classified-listing'),
            array(
                'classname'   => 'rtcl ' . $this->widget_slug . '-class',
                'description' => __('A list of classified listing Categories.', 'classified-listing')
            )
        );
    ...
    public function update($new_instance, $old_instance) {
        ...
        $instance['orderby'] = isset($new_instance['orderby']) ? esc_attr($new_instance['orderby']) : "name";
        $instance['order'] = isset($new_instance['order']) ? esc_attr($new_instance['order']) : "asc";
        $instance['hide_empty'] = isset($new_instance['hide_empty']) ? 1 : 0;
        $instance['show_count'] = isset($new_instance['show_count']) ? 1 : 0;
        $instance['show_image'] = isset($new_instance['show_image']) ? 1 : 0;
        $instance['show_icon'] = isset($new_instance['show_icon']) ? 1 : 0;
    ...
    public function form($instance) {
        ...
        $defaults = array(
            'title'          => __('Categories', 'classified-listing'),
            'parent'         => 0,
            'imm_child_only' => 0,
            'hide_empty'     => 1,
            'show_count'     => 1,
