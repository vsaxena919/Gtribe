...
class AjaxGallery {
    ...
    function gallery_update_order()
    {
        ...
        $dirty_ordered_keys = json_decode(stripslashes(Functions::request("ordered_keys")));
        ...
        update_post_meta($post_id, '_rtcl_attachments_order', $clean_ordered_keys_json);
    ...
    function gallery_upload()
    {
        ...
        if (is_array($form_scheme["field"]) && !empty($form_scheme["field"])) {
