...
class SessionHandler extends Session {
	...
	private function get_cache_prefix() {
		return CacheHelper::get_cache_prefix( RTCL_SESSION_CACHE_GROUP );
	}
	...
	public function destroy_session() {
		Functions::setcookie( $this->_cookie, '', time() - YEAR_IN_SECONDS, apply_filters( 'wc_session_use_secure_cookie', false ) );
	...
	public function cleanup_sessions() {
		...
		if ( class_exists( 'WC_Cache_Helper' ) ) {
			WC_Cache_Helper::incr_cache_prefix( RTCL_SESSION_CACHE_GROUP );
		}
	}
