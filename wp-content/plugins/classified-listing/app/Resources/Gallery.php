...
class Gallery {
	...
	static function rtcl_gallery_content($post = null, $conf = array())
	{
		...
		$init = array(
			...
			'filters'             => array(
				array(
					...
					'extensions' => implode(",", Functions::get_option_item('rtcl_misc_settings', 'image_allowed_type', array(
						'jpg',
						'jpeg',
						'png'
					)))
        ...
        <script type="text/javascript">
            ...
            RTCL_PLUPLOAD_DATA.push(<?php echo json_encode($upload_conf) ?>);

            if (typeof RTCL_IMAGE_SIZES === "undefined") {
                var RTCL_IMAGE_SIZES = <?php echo json_encode($sizes) ?>;
            }
        </script>
		<?php
	}
            ...
            <div class="wprtcl-overlay wprtcl-overlay-dark <?php echo is_admin() ? "rtcl-browser-admin" : "rtcl-browser-frontend" ?>">
                ...
                <div class="wprtcl-overlay-body">
                    ...
                    <div class="wprtcl-overlay-header">
                        ...
                        <div class="wprtcl-overlay-buttons"><!-- no line break
                    --><span class="wprtcl-overlay-button wprtcl-file-pagi-prev rtcl-icon-left-open wprtcl-navi-disabled"></span><!-- no line break
                    --><span class="wprtcl-overlay-button wprtcl-file-pagi-next rtcl-icon-right-open wprtcl-navi-disabled"></span><!-- no line break
        ...
        <script type="text/html" id="tmpl-wprtcl-browser-attachment-view">
            ...
            <div class="wprtcl-attachment-info">
                ...
                <div class="details">
                    ...
                    <div class="filename"><strong><?php _e("File name:", "classified-listing") ?></strong> {{ data.file.readable.name }}
                    </div>
                    <# } #>

                    <# if( data.file.readable.type ) { #>
                    <div class="filename"><strong><?php _e("File type:", "classified-listing") ?></strong> {{ data.file.readable.type }}
                    </div>
                    <# } #>

                    <# if( data.file.readable.uploaded ) { #>
                    <div class="uploaded"><strong><?php _e("Uploaded on:", "classified-listing") ?></strong> {{ data.file.readable.uploaded
                        }}
                    </div>
                    <# } #>

                    <# if( data.file.readable.size ) { #>
                    <div class="file-size"><strong><?php _e("File size:", "classified-listing") ?></strong> {{ data.file.readable.size }}
                    </div>
                    <# } #>
                    ...
                    <div class="formatted-length"><strong><?php _e("Length:", "classified-listing") ?></strong> {{ data.file.readable.length
                        }}
                    </div>
                    <# } #>
        ...
        <script type="text/html" id="tmpl-wprtcl-browser-attachment-image">
            ...
            <div class="wprtcl-attachment-info">
                    ...
                    <fieldset>
                        <div class="rtcl-control-group">
                            ...
                            <a href="#" class="rtcl-image-action-crop <?php echo $button ?> rtcl-button-small"
                               title="<?php _e("Crop", 'classified-listing') ?>"><span class="rtcl-icon-crop"></span></a>
                            <a href="#" class="rtcl-image-action-rotate-cw <?php echo $button ?> rtcl-button-small"
                               title="<?php _e("Rotate 90 degrees", 'classified-listing') ?>"><span class="rtcl-icon-cw"></span></a>
                            ...
                            <a href="#" class="rtcl-image-action-undo <?php echo $button ?> rtcl-button-small"
                               title="<?php _e("Undo", 'classified-listing') ?>"><span class="rtcl-icon-history"></span></a>
                ...
                <div class="details">
                    ...
                    <div class="filename"><strong><?php _e("Recommended size:", "classified-listing") ?></strong> <span
                    ...
                    <div class="wprtcl-image-selection"><strong><?php _e("Selection:", 'classified-listing') ?></strong> <span
