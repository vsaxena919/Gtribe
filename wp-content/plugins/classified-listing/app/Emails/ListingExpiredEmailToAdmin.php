...
class ListingExpiredEmailToAdmin extends RtclEmail {

	function __construct() {

		$this->id            = 'expired';
		$this->template_html = 'emails/listing-expired-email-to-admin';
	...
	public function get_default_subject() {
		return __( '[{site_title}] Listing "{listing_title}" is expired', 'classified-listing' );
	}
	...
	public function get_default_heading() {
		return __( 'Listing is expired', 'classified-listing' );
	}
