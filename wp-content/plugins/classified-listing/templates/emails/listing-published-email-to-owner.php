...
do_action( 'rtcl_email_header', $email ); ?>
    ...
    <p><?php printf( __( 'Your listing <strong>%1$s</strong> is now available at <a href="%2$s">%1$s</a> and can be viewed by the public.' ), $listing->get_the_title(), $listing->get_the_permalink() ) ?></p>
<?php
