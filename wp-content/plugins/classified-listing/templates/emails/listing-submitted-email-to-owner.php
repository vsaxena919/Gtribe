...
do_action( 'rtcl_email_header', $email ); ?>
    ...
    <p><?php printf( __( 'Your listing <strong>%s</strong> has been received and it\'s pending review. This review process could take up to 48 hours.' ), $listing->get_the_title() ) ?></p>
<?php
