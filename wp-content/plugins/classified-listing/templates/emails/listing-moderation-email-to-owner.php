...
do_action( 'rtcl_email_header', $email ); ?>
    ...
    <p><?php printf( __( 'You have received this email from the moderator to improve your listing. Your listing is <a href="%s">%s</a>' ), $listing->get_the_permalink(), $listing->get_the_title() ) ?></p>
    <p><?php _e( '<strong>Moderation:</strong>' ) ?></p>
