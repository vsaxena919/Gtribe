...
do_action( 'rtcl_email_header', $email ); ?>
    ...
    <p><?php printf( __( 'Your listing <strong>%s</strong> is about to expire at %s. You can renew it here: %s' ), $listing->get_the_title(), $email->get_placeholders_item( '{site_link_url}' ), $email->get_placeholders_item( '{renewal_link}' ) ) ?></p>
<?php
