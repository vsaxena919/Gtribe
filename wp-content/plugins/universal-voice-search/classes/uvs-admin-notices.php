        ...
        <div id="uvsDeniedActivationNoticeContainer">
            <div class="uvs-notice-info">
                ...
                <div id="uvsErrorNotice">
                    ...
                    <ul>
                        <li>Advanced features like AI search, Multi language support and many more. Check the comparison table below for all the features.</li>
