            ...
            <div class="inside">
                ...
                <div id="accordion">
                    ...
                    <div>
                        ...
                        <code>
                            function send_an_email_to_vote($ideaId, $userId, $voteIntent, $ideaScoreNow, $voteThreshold){

                                $voter = get_user_by('id',$userId);
                                $voter_email = $voter->user_email;
                                $voter_first_name = $voter->first_name;
                                $idea_title = get_the_title($ideaId);

                                $message = 'Hey '.$voter_first_name.', you just vote successfully for '.$idea_title;

                                //send an email wordpress
                                $to = $voter_email;
                                $subject = 'My subject';
                                $body = $message;
        ...
        <td scope="row" colspan="2">
            <div class="inside">
                ...
                <input type="text" class="regular-text" style="margin-left:10px;" id="idea_push_create_board">
                    <button class="button-secondary" style="margin-left:5px;" id="idea_push_create_board_button"><?php echo __('Add','ideapush'); ?></button>
