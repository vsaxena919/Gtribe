    ...
    if(strlen($a['board'])>0){
        ...
        if(is_array($individualBoardSetting)){
            ...
            if($currentUserId !== false){
                ...
                //echo 'The user roles are: '.implode(",", $currentUserRole).'</br>'; 
            ...
            if($userRoleCheck || $showBoardTo == "Everyone"){
                ...
                $html .= '<div class="ideapush-container" data="'.esc_attr($boardId).'">';
                    ...
                    $html .= '<div class="ideapush-container-header">';
                        ...
                        if($showVoteTarget == 'Yes'){
                            $html .= '<div class="ideapush-vote-target">'.__( 'Get your idea to', 'ideapush' ).' '.esc_html($voteThreshold).' '.__( 'to be reviewed', 'ideapush' ).'</div>';    
                        }
                    ...
                    $html .= '<div class="ideapush-container-ideas'.esc_attr($additionalContainerClass).'">';
                        ...
                        $html .= '<div class="ideapush-container-idea-header">'; //put border below me
                            ...
                            //fetch header
                            $html .= idea_push_header_render_output($a['board'],$defaultShowing,$defaultStatus,$defaultTag);
                        ...
                        $html .= '<ul class="dynamic-idea-listing" data="'.esc_attr($boardId).'">';
                            ...
                            $html .= idea_push_list_items($boardId,$defaultShowing,$defaultStatus,$defaultTag);
                ...
                //login form
                $html .= '<div style="display: none;" id="create-user-form" data-first="'.__( 'First name', 'ideapush' ).'" data-last="'.__( 'Last name', 'ideapush' ).'" data-email="'.__( 'Email', 'ideapush' ).'" data-email-confirm="'.__( 'Confirm email', 'ideapush' ).'"></div>';
