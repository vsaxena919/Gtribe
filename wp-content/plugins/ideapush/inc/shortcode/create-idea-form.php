...
function idea_push_form_render_output($boardNumber){
    ...
    //lets get the users info if they exist
            ...
            $html .= '<div class="user-profile-container">';
                ...
                if(!isset($options['idea_push_disable_profile_edit'])){
                    $html .= '<div class="user-profile-edit-form">';
                        ...
                        $html .= '<label class="ideapush-user-profile-attachment-label" for="userProfileImage"><i class="ideapush-icon-Image"></i> Update image</label>';
        ...
        if($showAttachments == 'Yes'){
            ...
            $html .= '<label class="ideapush-form-idea-attachment-label" for="fileToUpload"><i class="ideapush-icon-Image"></i> '.$attachmentText.'</label>';
        ...
        //submit button
        $html .= '<button class="submit-new-idea">'.$ideaButtonText.' <i class="ideapush-icon-Submit"></i></button>';
