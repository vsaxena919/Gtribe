...
function idea_push_common_status($ideaId,$oldStatus,$newStatus,$currentUser){
    ...
    if($newStatus !== $oldStatus){
        ...
        if(isset($options['idea_push_notification_author_idea_change_'.$statusRenamed.'_enable'])){
            ...
            do_action('idea_push_idea_status_change_author_notification',$ideaId,$options['idea_push_notification_author_idea_change_'.$statusRenamed.'_subject'].'|'.$options['idea_push_notification_author_idea_change_'.$statusRenamed.'_content']);
