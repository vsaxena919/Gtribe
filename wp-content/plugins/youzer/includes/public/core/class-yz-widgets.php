...
class Youzer_Widgets {
	...
	function get_all_widgets() {
		return apply_filters( 'yz_profile_widgets_args', array( 'post', 'link', 'quote', 'video', 'flickr', 'skills', 'groups', 'friends', 'project', 'reviews', 'about_me', 'services', 'user_tags', 'portfolio', 'slideshow', 'instagram', 'wall_media', 'user_badges', 'user_balance', 'recent_posts', 'phone', 'email', 'social_networks', 'website', 'address' ) );
	}
