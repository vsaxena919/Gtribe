...
function yz_groups_directory_group_cover( $group_id ) { 
    ...
    <div class="yz-group-cover" <?php echo yz_get_group_cover( $group_id ); ?>></div>
...
function youzer_groups_shortcode( $atts ) {
    ...
    // Add Filter.
    add_filter( 'bp_after_has_members_parse_args', 'yz_set_groups_directory_shortcode_atts' );
    ...
    // Remove Filter.
    remove_filter( 'bp_after_has_members_parse_args', 'yz_set_groups_directory_shortcode_atts' );
