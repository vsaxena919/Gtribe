...
function get_provider_instructions( $provider ) {
    ...
    switch ( $provider ) {
        ...
        case 'facebook':
            ...
            // Init Vars.
            $auth_url = home_url( '/?action=yz-social-login&provider=Facebook' ); 
        ...
        case 'google':
            ...
            $auth_url = home_url( '/?action=yz-social-login&provider=Google' ); 
            // Get Steps.
            $steps[] = sprintf( __( '1. Go to <a href="%1s">%2s</a>', 'youzer' ), $apps_url, $apps_url );
        ...
        case 'linkedin':
            ...
            $auth_url = home_url( '/?action=yz-social-login&provider=LinkedIn' ); 
        ...
        case 'instagram':
            ...
            $auth_url = home_url( '/?action=yz-social-login&provider=Instagram' ); 
